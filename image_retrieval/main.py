...
if __name__ == '__main__':
    ...
    gt = {"ima_000000.jpg": "ima_000076.jpg", "ima_000001.jpg": "ima_000105.jpg", "ima_000002.jpg": "ima_000034.jpg",
            ...
            for dist_func in DISTANCES:
                ...
                for query in db_query:
                    ...
                    for image in db_museum:
                        h0m, h1m, h2m = db_museum[image][hist_type][space_color]['hist']
                        image_h = np.concatenate([h0m, h1m, h2m])
